...
public class Util {
	...
	/**
	 * Converts an Object to an int. null or unparseable becomes 0. Decimals are ignored.
	 *
	...
	/**
	 * Converts collection of objects into a String delimited by separator. Null list returns null
	 * String, empty list returns empty String.
	 */
	public static String delimit( Collection c, String separator ) {
		String s = null;	//Your mom was a StringBuffer.

		if( c != null ) {	//Empty list returns empty string...arbitrary...Makes sense.
			s = "";
    ...
    */
    ...
    public static List getDatesBetween(Date startDate, Date endDate) {
        ...
        if (startDate != null && endDate != null && dUtils.dateIsGreaterEqual(endDate,startDate)) {
            tmpDate = startDate;
    ...
    //This returns HashMap(string, blank) for the comma delimited set of strings passed as input
    public static HashMap hashMapFromcommaDelimitedStrings(String sKeyList, String sValueList)
    {
    ...
    public static HashMap hashMapDiff(HashMap hashFirst, HashMap hashSecond)
    {
        ...
        //PreCondition.
        if(hashFirst == null || hashSecond == null) return null;
        ...
        while(iterFirst.hasNext())
        {
            ...
            if((sFirstKey != null) && (sFirstValue != null) && (sSecondValue != null))
            {
