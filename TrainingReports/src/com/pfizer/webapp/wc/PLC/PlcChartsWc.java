package com.pfizer.webapp.wc.PLC; 
...
extends WebComponent { 
    ...
    public PlcChartsWc( TerritoryFilterForm form, User user,WebComponent headerWc ) {
        ...
        //territorySelect = new TerritorySelectWc( form, user.getUserTerritory(), "/TrainingReports/PWRA/getFilteredChartPLC.do" );
        territorySelect = new TerritorySelectWc( form, user.getUserTerritoryOld(), "/TrainingReports/PWRA/getFilteredChartPLC" );
    ...
    {
        return "/WEB-INF/jsp/PLC/PlcCharts.jsp";
    }
