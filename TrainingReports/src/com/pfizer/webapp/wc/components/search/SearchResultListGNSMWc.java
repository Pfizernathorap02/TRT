...
public class SearchResultListGNSMWc extends WebComponent { 
	private List results;
	
	public SearchResultListGNSMWc(List results) {
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/SearchReportListGNSM.jsp";
	}
