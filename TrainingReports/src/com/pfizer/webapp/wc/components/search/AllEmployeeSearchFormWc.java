...
public class AllEmployeeSearchFormWc extends WebComponent { 
	private EmplSearchForm form;
	/*Infosys code changes starts here
	 * private String postUrl = "/TrainingReports/allEmployeeSearchList.do" ; */// default value for backward compaitibility
	private String postUrl = "/TrainingReports/allEmployeeSearchList" ; 
	private String target = "";
    private String onSubmit = "";
    private String user="";
    private boolean isAdmin = false;
    
	public AllEmployeeSearchFormWc(EmplSearchForm form) {
		this.form = form;
	}
    ...
    public void setUserEmplID(String user){
        this.user = user;
    }
	public boolean getIsEmplAdmin() {
		return this.isAdmin;
	}
    public void setIsEmplAdmin(boolean isAdmin) {
        System.out.println(isAdmin+"############################");
		this.isAdmin = isAdmin;
	}
		
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/AllEmployeeSearchForm.jsp";
	}
