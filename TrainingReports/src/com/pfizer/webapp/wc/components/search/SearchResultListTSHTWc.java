...
public class SearchResultListTSHTWc extends WebComponent { 
	private List results;
	
	public SearchResultListTSHTWc(List results) {
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/SearchReportListTSHT.jsp";
	}
