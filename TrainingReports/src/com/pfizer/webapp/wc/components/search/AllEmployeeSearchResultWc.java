...
public class AllEmployeeSearchResultWc extends WebComponent { 
	private List results;
	
	public AllEmployeeSearchResultWc(List results) {
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/AllEmployeeSearchUserList.jsp";
	}
