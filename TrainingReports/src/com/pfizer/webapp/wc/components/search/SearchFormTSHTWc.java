...
public class SearchFormTSHTWc extends WebComponent { 
	private EmplSearchTSHTForm form;
	
	public SearchFormTSHTWc(EmplSearchTSHTForm form) {
		this.form = form;
	}
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/SearchFormTSHT.jsp";
	}
