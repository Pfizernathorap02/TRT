...
public class SearchFormVRSWc extends WebComponent { 
	private EmplSearchForm form;
	
	public SearchFormVRSWc(EmplSearchForm form) {
		this.form = form;
	}
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/SearchFormVRS.jsp";
	}
