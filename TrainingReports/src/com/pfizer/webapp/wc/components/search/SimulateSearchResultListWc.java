...
public class SimulateSearchResultListWc extends WebComponent { 
	private List results;
	
	public SimulateSearchResultListWc(List results) {
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/simulateSearchUserList.jsp";
	}
