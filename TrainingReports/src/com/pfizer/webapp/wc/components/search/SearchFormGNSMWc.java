...
public class SearchFormGNSMWc extends WebComponent { 
	private EmplSearchForm form;
	
	public SearchFormGNSMWc(EmplSearchForm form) {
		this.form = form;
	}
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/SearchFormGNSM.jsp";
	}
