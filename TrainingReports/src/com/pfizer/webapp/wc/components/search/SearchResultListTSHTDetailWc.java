...
public class SearchResultListTSHTDetailWc extends WebComponent { 
	private List results;
	
	public SearchResultListTSHTDetailWc(List results) {
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/SearchReportListTSHTDetail.jsp";
	}
