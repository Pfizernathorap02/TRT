...
public class SearchFormPOAWc extends WebComponent { 
	private EmplSearchForm form;
	
	public SearchFormPOAWc(EmplSearchForm form) {
		this.form = form;
	}
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/SearchFormPOA.jsp";
	}
