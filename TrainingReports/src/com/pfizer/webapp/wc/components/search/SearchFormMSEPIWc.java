...
public class SearchFormMSEPIWc extends WebComponent { 
	private EmplSearchForm form;
	
	public SearchFormMSEPIWc(EmplSearchForm form) {
		this.form = form;
	}
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/SearchFormMSEPI.jsp";
	}
