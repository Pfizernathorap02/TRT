...
public class NASearchResultListWc extends WebComponent
{ 
    
    private List results;
	
	public NASearchResultListWc(List results) {
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/NASearchUserList.jsp";
	}
/*Vinod here needs a change*/
