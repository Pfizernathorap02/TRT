...
public class DelegateSearchResultListWc extends WebComponent { 
	private List results;
	private String source;
    
	public DelegateSearchResultListWc(List results) {
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/DelegateSearchUserList.jsp";
	}
