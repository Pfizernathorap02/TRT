...
public class SearchFormPDFHSWc extends WebComponent { 
	private EmplSearchForm form;
	
	public SearchFormPDFHSWc(EmplSearchForm form) {
		this.form = form;
	}
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/SearchFormPDFHS.jsp";
	}
