...
public class SearchResultListPOAWc extends WebComponent { 
	private List results;
	
	public SearchResultListPOAWc(List results) {
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/SearchReportListPOA.jsp";
	}
