...
public class SearchResultListPDFHSWc extends WebComponent { 
	private List results;
	
	public SearchResultListPDFHSWc(List results) {
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/SearchReportListPDFHS.jsp";
	}
