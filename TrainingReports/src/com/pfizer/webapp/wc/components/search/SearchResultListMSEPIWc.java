...
public class SearchResultListMSEPIWc extends WebComponent { 
	private List results;
	
	public SearchResultListMSEPIWc(List results) {
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/search/SearchReportListMSEPI.jsp";
	}
