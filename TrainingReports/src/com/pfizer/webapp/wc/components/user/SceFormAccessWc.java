...
public class SceFormAccessWc extends WebComponent { 
	private List results;
    private List resulttypeList;
    private List phaseresult;
...
*/	
	public SceFormAccessWc(List result,List resulttypeList, List phaseresult) {
		this.results = result;
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/user/sceuseraccessgroupList.jsp";
	}
