...
public class PhaseEvaluationWc extends WebComponent { 
...
*/	
	public PhaseEvaluationWc(List result, List reportTypeList) {
		this.results = result;
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/user/phaseEvaluation.jsp";
	}
