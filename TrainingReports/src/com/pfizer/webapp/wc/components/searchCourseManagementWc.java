...
public class searchCourseManagementWc extends WebComponent
{ 
   /* private List courseList;
    ...
    public searchCourseManagementWc(){}
    
    public String getJsp()
    {
        return AppConst.JSP_LOC + "/components/searchCourseManagement.jsp";
    }
