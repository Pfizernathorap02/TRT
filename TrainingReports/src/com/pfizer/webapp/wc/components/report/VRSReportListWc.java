...
public class VRSReportListWc extends WebComponent 
{ 
  ...
  private int layout = 1;
    public String getJsp(){
        ...
        return AppConst.JSP_LOC + "/components/report/VRSReportList.jsp";
    }
    ...
    public VRSReportListWc(UserFilter filter, Employee[] emplBean, User user){
         if(emplBean !=null)
         {
     ...
     public VRSReportListWc(UserFilter filter, Employee[] emplBean, User user, boolean excel){
         if(emplBean !=null)
         {
            System.out.println("EmplBean length here is "+emplBean.length);
         }
