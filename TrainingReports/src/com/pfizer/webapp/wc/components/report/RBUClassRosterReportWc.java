...
public class RBUClassRosterReportWc extends WebComponent
{
    ...
    public RBUClassRosterReportWc(RBUClassRosterBean[] empReport, String event, TrainingWeeks[] week, String displayResult) {
    ...
    public String getJsp() {
        return AppConst.JSP_LOC + "/components/report/RBUClassRosterReport.jsp";
	}
