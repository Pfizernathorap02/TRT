...
public class RBUReportList extends WebComponent
{
  ...
  public String getJsp()

    {
			...
			return AppConst.JSP_LOC + "/components/report/RBUReportListXls.jsp";
		}
        return AppConst.JSP_LOC + "/components/report/RBUReportList.jsp";
    }
    ...
    RBUReportList(UserFilter filter, Employee[] emplBean, User user){
//         System.out.println("EmplBean length here is "+emplBean.length);
         qStrings = filter.getQuseryStrings();
         this.user=user;
        setEmployeeBean(emplBean);
    }
    RBUReportList(UserFilter filter, Employee[] emplBean, User user, ProductDataBean[] product){
//         System.out.println("EmplBean length here is "+emplBean.length);
         qStrings = filter.getQuseryStrings();
         this.user=user;
     ...
     RBUReportList(UserFilter filter, Employee[] emplBean, User user, boolean excel,ProductDataBean[] product){
         System.out.println("EmplBean length here is "+emplBean.length);
         qStrings = filter.getQuseryStrings();
         this.user=user;
         this.product = product;
