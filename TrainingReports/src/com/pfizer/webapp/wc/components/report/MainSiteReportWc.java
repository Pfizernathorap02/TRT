...
public class MainSiteReportWc extends WebComponent { 
	private WebComponent reportWc;
	
	public MainSiteReportWc() {
	}
	
	
	public void setReportWc( WebComponent wc) {
		this.reportWc = wc;
	}	
	public WebComponent getReportWc() {
		return reportWc;
	}
	
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/report/MainSiteReport.jsp";
	}
