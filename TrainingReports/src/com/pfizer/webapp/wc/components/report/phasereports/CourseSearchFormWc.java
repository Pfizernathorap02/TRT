...
public class CourseSearchFormWc extends WebComponent { 
    private CourseSearchForm form;
    	
	public CourseSearchFormWc(CourseSearchForm form) {
        this.form = form;
    }
    
    public CourseSearchForm getForm() {
        return form;
    }
    public String getJsp() {
        return AppConst.JSP_LOC + "/components/report/phasereports/CourseSearchForm.jsp";
    }
