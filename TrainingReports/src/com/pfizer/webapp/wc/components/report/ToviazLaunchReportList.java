...
public class ToviazLaunchReportList extends WebComponent
{
  ...
  public String getJsp()

    {
        ...
        return AppConst.JSP_LOC + "/components/report/ToviazLaunchReportList.jsp";
    }
    ...
    ToviazLaunchReportList(UserFilter filter, Employee[] emplBean, User user){
//         System.out.println("EmplBean length here is "+emplBean.length);
         qStrings = filter.getQuseryStrings();
         this.user=user;
        setEmployeeBean(emplBean);
    }
    ToviazLaunchReportList(UserFilter filter, Employee[] emplBean, User user, ProductDataBean[] product){
//         System.out.println("EmplBean length here is "+emplBean.length);
         qStrings = filter.getQuseryStrings();
         this.user=user;
     ...
     ToviazLaunchReportList(UserFilter filter, Employee[] emplBean, User user, boolean excel){
         System.out.println("EmplBean length here is "+emplBean.length);
         qStrings = filter.getQuseryStrings();
         this.user=user;
        setEmployeeBean(emplBean);
