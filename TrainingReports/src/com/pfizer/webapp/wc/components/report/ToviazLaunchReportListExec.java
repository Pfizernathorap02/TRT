...
public class ToviazLaunchReportListExec extends WebComponent
{
  ...
  public String getJsp()

    {
			...
			return AppConst.JSP_LOC + "/components/report/ToviazLaunchReportListXls.jsp";
		}
        return AppConst.JSP_LOC + "/components/report/ToviazLaunchReportListExec.jsp";
    }
    ...
    ToviazLaunchReportListExec(UserFilter filter, Employee[] emplBean, User user){
//         System.out.println("EmplBean length here is "+emplBean.length);
         qStrings = filter.getQuseryStrings();
         this.user=user;
        setEmployeeBean(emplBean);
    }
    ToviazLaunchReportListExec(UserFilter filter, Employee[] emplBean, User user, ProductDataBean[] product){
//         System.out.println("EmplBean length here is "+emplBean.length);
         qStrings = filter.getQuseryStrings();
         this.user=user;
     ...
     ToviazLaunchReportListExec(UserFilter filter, Employee[] emplBean, User user, boolean excel){
         System.out.println("EmplBean length here is "+emplBean.length);
         qStrings = filter.getQuseryStrings();
         this.user=user;
        setEmployeeBean(emplBean);
