...
public class MSEPIReportListWc extends WebComponent 
{ 
  ...
  private int layout = 1;
    public String getJsp(){
        ...
        return AppConst.JSP_LOC + "/components/report/MSEPIReportList.jsp";
    }
    ...
    public MSEPIReportListWc(UserFilter filter, Employee[] emplBean, User user){
     ...
     public MSEPIReportListWc(UserFilter filter, Employee[] emplBean, User user, boolean excel){
         System.out.println("EmplBean length here is "+emplBean.length);
         qStrings = filter.getQuseryStrings();
         this.user=user;
        setEmployeeBean(emplBean);
