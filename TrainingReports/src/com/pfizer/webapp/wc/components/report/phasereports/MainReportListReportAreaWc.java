...
public class MainReportListReportAreaWc extends WebComponent {
...
// Added for TRT enhancement 3.6 (Employee grid user view)
    private List selOptFields;
    private UserSession session;
// end of modification
    public static final int LAYOUT_XLS = 1;
    
	public MainReportListReportAreaWc(Collection result, User usr, String activityPk, String section) {
		super();
        this.result = result;
    ...
    // Added for TRT enhancement 3.6 (Employee grid user view)
	public MainReportListReportAreaWc(Collection result, User usr, String activityPk, String section,List optFields ) {
		super();
        this.result = result;
        this.currentUser = usr;
        this.activityPk = activityPk;
        this.section=section;
        this.selOptFields=optFields;
	}
    
    public List getSelOptFields()
    {
        return this.selOptFields;
    }
    // end of modification
    ...
    public String getJsp() {
        if ( layout == LAYOUT_XLS ) {
            return AppConst.JSP_LOC + "/components/report/phasereports/MainReportListReportAreaXls.jsp";
        }
        return AppConst.JSP_LOC + "/components/report/phasereports/MainReportListReportArea.jsp";
	}
