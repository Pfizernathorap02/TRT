...
public class PLCReportList extends WebComponent 
{ 
  ...
  public String getJsp()  
    
    {
        ...
        return AppConst.JSP_LOC + "/components/report/PLCReportList.jsp";
    }
    ...
    public PLCReportList(UserFilter filter, Employee[] emplBean, User user){
     ...
     public PLCReportList(UserFilter filter, Employee[] emplBean, User user, boolean excel){
         System.out.println("EmplBean length here is "+emplBean.length);
         qStrings = filter.getQuseryStrings();
         this.user=user;
        setEmployeeBean(emplBean);
