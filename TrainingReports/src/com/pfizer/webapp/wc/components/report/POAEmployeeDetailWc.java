...
public class POAEmployeeDetailWc extends WebComponent { 
	...
	public POAEmployeeDetailWc(Employee employee,  User user,EmpSearchPOA[] empSearchPOA) {
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/components/report/POAEmployeeDetail.jsp";
	}
