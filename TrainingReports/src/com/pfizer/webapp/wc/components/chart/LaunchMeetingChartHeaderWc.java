...
public final class LaunchMeetingChartHeaderWc extends WebComponent {
    ...
    private String jsp = AppConst.JSP_LOC + "/components/chart/launchMeetingChartHeader.jsp";




	public LaunchMeetingChartHeaderWc(String bu, String rbu, int numTrainess) {
