...
public final class RBUChartHeaderWc extends WebComponent {
    ...
    private String jsp = AppConst.JSP_LOC + "/components/chart/rbuChartHeader.jsp";




	public RBUChartHeaderWc(String product, String bu, String rbu, int numTrainess) {
