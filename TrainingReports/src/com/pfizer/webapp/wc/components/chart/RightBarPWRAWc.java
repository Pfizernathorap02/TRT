...
public class RightBarPWRAWc extends WebComponent { 
	...
	public RightBarPWRAWc(TerritoryFilterForm form, User user, String postUrl) {
		...
		territorySelect = new TerritorySelectWc( form, user.getUserTerritoryOld(), postUrl );
    ...
    public String getJsp() {
		...
		return AppConst.JSP_LOC + "/components/chart/rightBarPWRA.jsp";
