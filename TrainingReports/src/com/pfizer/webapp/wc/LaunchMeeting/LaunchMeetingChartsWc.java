package com.pfizer.webapp.wc.LaunchMeeting;
...
public class LaunchMeetingChartsWc extends WebComponent {
    ...
    public LaunchMeetingChartsWc(TerritoryFilterForm form, User user, WebComponent headerWc) {
        super();
     ...
     public LaunchMeetingChartsWc(User user, WebComponent headerWc) {
        super();
        this.headerWc = headerWc;
    }
    ...
    {
        return "/WEB-INF/jsp/LaunchMeeting/LaunchMeetingCharts.jsp";
    }
