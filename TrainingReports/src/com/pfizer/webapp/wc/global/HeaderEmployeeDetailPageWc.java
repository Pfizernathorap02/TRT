...
public class HeaderEmployeeDetailPageWc extends WebComponent
{
	...
	public HeaderEmployeeDetailPageWc(String pageId) {
		this.pageId = pageId;
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/global/headerEmployeeDetailPage.jsp";
	}
