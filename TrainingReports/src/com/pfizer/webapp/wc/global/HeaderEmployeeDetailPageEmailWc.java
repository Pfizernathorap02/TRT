...
public class HeaderEmployeeDetailPageEmailWc extends WebComponent
{
	...
	public HeaderEmployeeDetailPageEmailWc(String pageId) {
		this.pageId = pageId;
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/global/headerEmployeeDetailPageEmail.jsp";
	}
