...
public class HeaderUnAuthorizedRoleWc extends WebComponent
{
	...
	public HeaderUnAuthorizedRoleWc(String pageId) {
		this.pageId = pageId;
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/global/headerUnAuthorizedRole.jsp";
	}
