...
public class HeaderLaunchMeetingReportsWc extends WebComponent
{
	...
	public HeaderLaunchMeetingReportsWc(String pageId) {
		this.pageId = pageId;
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/global/headerLaunchMeetingReports.jsp";
	}
