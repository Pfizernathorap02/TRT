...
public class HeaderFailureReportWc extends WebComponent
{  
    private HeaderBottomLinks bottomLinks;
	private String pageId = new String();
	private boolean showNav = true;
	
	public HeaderFailureReportWc(String pageId) {
		this.pageId = pageId; 
    ...
    public String getJsp() {
		return AppConst.JSP_LOC + "/global/headerFailureReport.jsp";
	}
