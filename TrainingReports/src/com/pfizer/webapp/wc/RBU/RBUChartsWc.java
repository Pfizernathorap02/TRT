...
public class RBUChartsWc extends WebComponent {
    ...
    public RBUChartsWc(TerritoryFilterForm form, User user, WebComponent headerWc) {
        super();
     ...
     public RBUChartsWc(User user, WebComponent headerWc) {
        super();
        this.headerWc = headerWc;
    }
    ...
    {
        return "/WEB-INF/jsp/RBU/RBUCharts.jsp";
    }
