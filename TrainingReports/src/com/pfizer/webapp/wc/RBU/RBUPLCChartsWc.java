...
public class RBUPLCChartsWc extends WebComponent 
{ 
    ...
    public RBUPLCChartsWc(TerritoryFilterForm form, User user, WebComponent headerWc) {
        super();
        ...
        territorySelect = new TerritorySelectWc( form, user.getUserTerritory(), "/TrainingReports/RBU/getFilteredChart" );
    ...
    {
        return "/WEB-INF/jsp/RBU/RBUPLCCharts.jsp";
    }
