...
public class GNSMHandler { 
    ...
    public int getOverAllTotalCount(String productCd,String areaCd,String regionCd,String districtId,String teamCd) {
        String sqlQuery1=" SELECT COUNT(DISTINCT EMPLID) COUNT FROM V_GNSM_DATA_OVERALL WHERE OVERALL_STATUS IN ('L','I','P') ";
        //ConditionQuery
        String condQuery="";
...
*/        
    ...
    public POAChartBean[] getFilteredChartAttendance(String trtCourseCd,String areaCd,String regionCd,String districtId,String teamCd){
        ...
        */
        ...
        String sqlCompleteQueryM= " SELECT 'Complete' COURSESTATUS, COUNT (*) TOTAL FROM V_GNSM_ATTENDANCE_DATA WHERE STATUS = 'P' ";        
        String sqlOnLeaveQueryM= " SELECT  'OnLeave' COURSESTATUS, COUNT (*) TOTAL FROM ";
        String sqlOnLeaveQueryL = " SELECT DISTINCT EMPLID TOTAL FROM V_GNSM_ATTENDANCE_DATA WHERE STATUS = 'L' ";
        String sqlOnLeaveQueryP = " SELECT DISTINCT EMPLID TOTAL FROM V_GNSM_ATTENDANCE_DATA WHERE  STATUS = 'P' ";
        String sqlInCompleteQueryM = " SELECT 'InComplete' COURSESTATUS, COUNT (*) TOTAL FROM ";
        String sqlInCompleteQueryI = " SELECT DISTINCT EMPLID TOTAL FROM V_GNSM_ATTENDANCE_DATA WHERE STATUS = 'I' ";
        String sqlInCompleteQueryP = " SELECT DISTINCT EMPLID TOTAL FROM V_GNSM_ATTENDANCE_DATA WHERE  STATUS = 'P' ";
        String sqlInCompleteQueryL = " SELECT DISTINCT EMPLID TOTAL FROM V_GNSM_ATTENDANCE_DATA WHERE  STATUS = 'L' ";
        //ConditionQuery
        String condQuery="";
        if(!"ALL".equalsIgnoreCase(areaCd)){
         condQuery=condQuery+ "AND AREA_CD='"+areaCd+"' ";
    ...
    public POAChartBean[] getFilteredOverallChart(String productCd,String areaCd,String regionCd,String districtId,String teamCd){
        ...
        String sqlQueryComplete = "SELECT 'Complete' COURSESTATUS, COUNT (DISTINCT EMPLID) TOTAL FROM V_GNSM_DATA_OVERALL WHERE OVERALL_STATUS = 'P' ";
        String sqlQueryInComplete = "SELECT 'InComplete' COURSESTATUS, COUNT (DISTINCT EMPLID) TOTAL FROM V_GNSM_DATA_OVERALL WHERE OVERALL_STATUS = 'I' ";
        String sqlQueryOnLeave = "SELECT 'OnLeave' COURSESTATUS, COUNT (DISTINCT EMPLID) TOTAL FROM V_GNSM_DATA_OVERALL WHERE OVERALL_STATUS = 'L' ";
