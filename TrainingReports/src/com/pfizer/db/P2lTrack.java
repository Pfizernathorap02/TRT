...
public class P2lTrack {
    ...
    public static final String FIELD_DO_COMPLETE = "doComplete";
    ...
    public boolean getDoComplete() {
        return "Y".equals(this.doComplete);
         
    }
    public void setDoComplete( String str ) {
        this.doComplete = str;
    }
    ...
    public void setPhases( List list ) {
        ...
        for ( Iterator it = list.iterator(); it.hasNext(); ) {
            P2lTrackPhase tmp = (P2lTrackPhase)it.next();
