...
try{
    ...
    System.out.println("JSP:::product = "+product);    
        ...
        if(url !=null && (url.indexOf("localhost") > 0))
        {
            ...
            env = "http://localhost:8080/SCEWeb/evaluation/";	
            System.out.println("JSP:::Localhost env = "+env);
        }
        else if ( url != null && (url.indexOf("trt-dev.pfizer.com") > 0))
        {
            ...
            env = "http://sce-dev.pfizer.com/SCEWeb/evaluation";	
        ...
        {
          redirectUrl=env+"goToLegalCheckTr?linkName="+linkName+"&ntId="+ntId+"&emplId="+emplId+"&productCode="+productCode+"&eventId="+eventId+"&loginUserNtId="+loginUserNtId;
        ...
        {
          redirectUrl=env+"goToHistoryCheckTr?linkName="+linkName+"&ntId="+ntId+"&emplId="+emplId+"&productCode="+productCode+"&eventId="+eventId+"&loginUserNtId="+loginUserNtId; 
