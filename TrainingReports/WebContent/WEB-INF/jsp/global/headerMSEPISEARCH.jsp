...
<%@ page import="com.pfizer.webapp.wc.global.HeaderMSEPISEARCHWc"%>
<%@ page import="com.pfizer.webapp.wc.global.HeaderSEARCHWc"%>
<%@ page import = "com.pfizer.webapp.wc.global.HeaderWc" %>
<%
	HeaderMSEPISEARCHWc wc = (HeaderMSEPISEARCHWc)request.getAttribute(HeaderMSEPISEARCHWc.ATTRIBUTE_NAME);
    //wc.setShowNav(false);
%>
...
<div id=top_header>
	...
	<div id=header_title>MS/Epi National Sales Meeting Search</div>
