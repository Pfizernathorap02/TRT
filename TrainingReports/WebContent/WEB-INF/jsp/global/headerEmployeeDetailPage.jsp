...
<%@ page import="com.pfizer.webapp.wc.global.HeaderEmployeeDetailPageWc"%>
<%@ page import="com.pfizer.webapp.wc.global.HeaderPWRAWc"%>
<%@ page import = "com.pfizer.webapp.wc.global.HeaderWc" %>
<%
    HeaderEmployeeDetailPageWc wc = (HeaderEmployeeDetailPageWc)request.getAttribute(HeaderPWRAWc.ATTRIBUTE_NAME);
...
<div id=top_header>
	...
	<div id=header_title>Product Training (PSCPT) - Employee Details Page<br><div style="font-size:.7em; color:red;"><%=wc.getHeadString()%><div></div>
