...
<%@ page import="com.pfizer.webapp.wc.global.HeaderEmployeeDetailPageEmailWc"%>
<%@ page import="com.pfizer.webapp.wc.global.HeaderPWRAWc"%>
<%@ page import = "com.pfizer.webapp.wc.global.HeaderWc" %>
<%
    HeaderEmployeeDetailPageEmailWc wc = (HeaderEmployeeDetailPageEmailWc)request.getAttribute(HeaderPWRAWc.ATTRIBUTE_NAME);
    String sReportType = (String)request.getSession().getAttribute("ReportType");
    if(sReportType == null) sReportType = "";
%>

<div id=top_header>
	<%--<a href="<%=AppConst.APP_ROOT%>/reportselect" onmouseover="this.style.cursor='hand'">
	<div id=header_logo></div></a>
	--%>
	<div id=header_logo></div>
	<div id=header_title>Product Training (PSCPT) - Employee Details Page</div>
