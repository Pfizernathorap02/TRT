...
<%
	HeaderToviazLaunchReportsWc wc = (HeaderToviazLaunchReportsWc)request.getAttribute(HeaderPWRAWc.ATTRIBUTE_NAME);
...
<div id=top_header>
	...
	<div id=header_title>Toviaz Launch  Reports</div>
