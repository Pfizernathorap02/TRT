...
<%
	HeaderPLCWc wc = (HeaderPLCWc)request.getAttribute(HeaderPLCWc.ATTRIBUTE_NAME);
...
<div id=top_header>
	...
	<div id=header_title>POWERS Driving Force PLC Report</div>
	
	<UL id=header_top_nav>                                     
        <%-- Infosys Code changes starts here
        <LI><a href="<%=AppConst.APP_ROOT%>/reportselect.do">Home</a></LI>
		<LI ><a href="<%=AppConst.APP_ROOT%>/searchPDFHS.do?m0=search&m1=PDF&m2=PLC">Search</a></LI> --%>
      
   	    <LI><a href="<%=AppConst.APP_ROOT%>/reportselect.">Home</a></LI>
		<LI ><a href="<%=AppConst.APP_ROOT%>/searchPDFHS?m0=search&m1=PDF&m2=PLC">Search</a></LI>
