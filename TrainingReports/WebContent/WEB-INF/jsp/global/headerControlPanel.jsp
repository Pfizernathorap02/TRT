...
<%@ page import="com.pfizer.webapp.wc.global.HeaderControlPanelWc"%>
<%@ page import="com.pfizer.webapp.wc.global.HeaderPWRAWc"%>
<%@ page import = "com.pfizer.webapp.wc.global.HeaderWc" %>
<%
    HeaderControlPanelWc wc = (HeaderControlPanelWc)request.getAttribute(HeaderPWRAWc.ATTRIBUTE_NAME);
...
<div id=top_header>
	...
	<div id=header_title>Product Training (PSCPT) Control Panel</div>
