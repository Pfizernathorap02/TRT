...
<%
	HeaderPWRAWc wc = (HeaderPWRAWc)request.getAttribute(HeaderPWRAWc.ATTRIBUTE_NAME);
...
<div id=top_header>
	...
	<div id=header_title>POWERS Driving Force Home Study Report</div>
	
	<UL id=header_top_nav>                                     
        <LI><a href="<%=AppConst.APP_ROOT%>/reportselect">Home</a></LI>		
	   <LI ><a href="<%=AppConst.APP_ROOT%>/searchPDFHS?m0=search&m1=PDF&m2=HS">Search</a></LI>
