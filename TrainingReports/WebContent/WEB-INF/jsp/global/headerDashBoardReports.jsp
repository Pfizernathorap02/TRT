...
<%@ page import="com.pfizer.webapp.wc.global.HeaderDashBoardReportsWc"%>
<%@ page import="com.pfizer.webapp.wc.global.HeaderPWRAWc"%>
<%@ page import = "com.pfizer.webapp.wc.global.HeaderWc" %>
<%
	HeaderDashBoardReportsWc wc = (HeaderDashBoardReportsWc)request.getAttribute(HeaderPWRAWc.ATTRIBUTE_NAME);
