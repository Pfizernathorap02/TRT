...
<%
//	RBUPLCChartsWc wc = (RBUPLCChartsWc)request.getAttribute(RBUPLCChartsWc.ATTRIBUTE_NAME);
	RBUChartsWc wc = (RBUChartsWc)request.getAttribute(RBUChartsWc.ATTRIBUTE_NAME);
   // RBUChartsWc wc = new RBUChartsWc();
    RBUChartHeaderWc chartHeaderWc=(RBUChartHeaderWc)wc.getHeader();
    ChartListWc list = (ChartListWc)wc.getWebComponent();
    ProductDataBean thisProductDataBean[];
    //thisProductDataBean = (ProductDataBean[])request.getAttribute("products");
    ...
    if(wc.getSelectedBu() != null){
        selectedBU = wc.getSelectedBu();
    }
    if(wc.getSelectedRbu() != null){
        selectedRBU = wc.getSelectedRbu();
    }
...
%>
 ...
 var url = '/TrainingReports/RBU/getFilteredChart?selectedProduct='+encodeURIComponent(product)+'&selectedProductDesc='+encodeURIComponent(productValue)+'&selectedBU='+encodeURIComponent(bu)+'&selectedRBU='+encodeURIComponent(rbu);
...
<table class="basic_table">
	<tr>
		<td colspan="3">
			<table class="basic_table">
				<tr>
					<td align="center">	
                    <label>  &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;Charts based on </label><%=list.getTrainees()%> 

			<label>Trainees.</label>
                    	
							&nbsp;&nbsp;&nbsp;<label>Product:</label> <%=chartHeaderWc.getProduct()%>&nbsp;&nbsp;
	...
	<tr>
		...
		<td valign="top">
            ...
            <table width="400" class="basic_table">
                <tr>
                    <td><label>Product:</label></td>
                    <td>
                    <select name="product" id="product">
                    <%
                        if(selectedProduct.equalsIgnoreCase("OVERALL")){
                    %>
                ...
                <td><label>BU:</label></td>
                    <td>
                    <select name="bu" onchange="getRBUValues()" id="bu" >
                    <%
