...
<%@ page import="com.pfizer.webapp.wc.components.report.PDFHSEmployeeDetailWc"%>
...
<%
	PDFHSEmployeeDetailWc wc = (PDFHSEmployeeDetailWc)request.getAttribute(PDFHSEmployeeDetailWc.ATTRIBUTE_NAME);
...
<table class="basic_table">
	<tr>		
		...
		<td>
			...
			<br>
			<br>
			Powers Driving Force Colleague Detail
					...
					<td width="0">
						<table class="blue_table" >
							...
							<tr class="even">
								...
								<td><a href="mailto:<%=employee.getEmail()%>?subject=Powers Driving Force Follow-up"><%=employee.getEmail()%></a></td>
							</tr>	
							<tr class="odd">
							...
							<tr class="odd">
								...
								<td><% if (reportsTo != null) { %>
									<a href="mailto:<%=reportsTo.getEmail()%>?subject=Powers Driving Force Follow-up">	<%=reportsTo.getLastName()%>, <%=reportsTo.getPreferredName()%> </a>
									<% } %>
								</td>
							</tr>	
						</table>
