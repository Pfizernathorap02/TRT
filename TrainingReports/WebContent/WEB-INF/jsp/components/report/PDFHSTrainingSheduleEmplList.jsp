...
<html>
    <head>
        <title>
            PDF - Training Schedule Detail Report
        </title>
    </head>
    ...
    <body>
        ...
        <div style="margin-left:10px;margin-right:10px">
            ...
            %>
                <img src="<%=AppConst.APP_ROOT%>/resources/images/excel.gif" width="15px">&nbsp;<a href="<%=AppConst.APP_ROOT%>/PWRA/PDFHSReportTrainingScheduleEmplList?downloadExcel=true<%=excelURL%>">Download to Excel</a>
                &nbsp;&nbsp;|&nbsp;&nbsp;
                <%if(!enrollmentPage){%>
                    <a href="<%=AppConst.APP_ROOT%>/PWRA/PDFHSReportTrainingSchedule">Back To Training Schedule Summary</a>
                <%}else{%>
        ...
        <%if (downloadExcel) {%>
        <tr>
            <td colspan="5"><b>PDF - Training Schedule Detail Report</b></td>
        </tr>
        <tr></tr>
        <%}%>
        <tr>
