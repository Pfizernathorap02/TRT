...
<html>
    <head>
        <title>
            SPF - Personalized Agenda Report
        </title>
    </head>
    ...
    <body>
        ...
        <div style="margin-left:10px;margin-right:10px">
            <div id="table_inst">
               ...
               <img src="<%=AppConst.APP_ROOT%>/resources/images/excel.gif" width="15px">&nbsp;<a href="<%=AppConst.APP_ROOT%>/SPF/SPFHSReportPersonalAgenda.do?downloadExcel=true">Download to Excel</a>
                &nbsp;&nbsp;|&nbsp;&nbsp;
                <a href="<%=AppConst.APP_ROOT%>/spfreportselect.do">SPF Reports Home</a> --%>
                 <img src="<%=AppConst.APP_ROOT%>/resources/images/excel.gif" width="15px">&nbsp;<a href="<%=AppConst.APP_ROOT%>/SPF/SPFHSReportPersonalAgenda?downloadExcel=true">Download to Excel</a>
                &nbsp;&nbsp;|&nbsp;&nbsp;
        ...
        <%if (downloadExcel) {%>
        <tr>
            <td colspan="5"><b>SPF - Personalized Agenda Report</b></td>
        </tr>
        <tr></tr>
        <%}%>
        <tr>
