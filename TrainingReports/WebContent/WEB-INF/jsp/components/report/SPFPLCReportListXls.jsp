         ...
         <tr  >
				...
				<td>&nbsp;<%=emp.getEmplId()%></td>
                 ...
                 <%if("Overall".equalsIgnoreCase(xlsType)){
                    ...
                    %> 
                    <td ><%=Util.toEmptyNA((String)empHashMap.get("DETR"))%></td>
                    <td ><%=Util.toEmptyNA((String)empHashMap.get("CHTX"))%></td>
                    <td ><%=Util.toEmptyNA((String)empHashMap.get("SPRV"))%></td>
                    <td ><%=Util.toEmptyNA((String)empHashMap.get("VIAG"))%></td>
