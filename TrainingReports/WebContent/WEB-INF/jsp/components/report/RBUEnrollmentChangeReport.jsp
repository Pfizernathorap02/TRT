...
<%@ page import="com.pfizer.db.RBUEnrollChangeReport"%>
<%@ page import="com.pfizer.webapp.AppConst"%>
<%@ page import="com.pfizer.webapp.wc.components.report.EnrollmentChangeReportWc"%>
<%@ page import="com.pfizer.webapp.wc.components.report.RBUEnrollmentChangeReportWc"%>
...
<%! private HashMap getEmplIDSize(RBUEnrollChangeReport[] empReport){
...
%>
    <body>
        ...
        RBUEnrollmentChangeReportWc wc = (RBUEnrollmentChangeReportWc)request.getAttribute(ListReportWpc.ATTRIBUTE_NAME);                 
        RBUEnrollChangeReport[] empReport = wc.getEmpReport();        
        
        SimpleDateFormat format = new SimpleDateFormat("MM/dd/yyyy");

        title = "Product Training (PSCPT) - Enrollment Change Report";
        backMenu ="PSCPT Admin Reports";
        /* Infosys code changes starts here
        backLink ="rbusreportselect.do";  
        excelURL = "/RBU/RBUEnrollmentChangeReport.do";    */   
        backLink ="rbusreportselect";  
        excelURL = "/RBU/RBUEnrollmentChangeReport"; 
            ...
            <tr>            
                ...
                %>                
                    ...
                    <td rowspan="<%=rowSpanSize%>" valign="top">
                      <%-- Infosys code changes starts here
                      <a href="<%=AppConst.APP_ROOT%>/RBU/employeeDetail/getEmployeeDetails.do?emplid=<%=empReport[i].getEmplId()%>&m0=report&m1=PDF">
                       --%>
                      <a href="<%=AppConst.APP_ROOT%>/RBU/employeeDetail/getEmployeeDetails?emplid=<%=empReport[i].getEmplId()%>&m0=report&m1=PDF">
                ...
                <td <%=sHighlight%>><%=Util.toEmptyNBSP(empReport[i].getChanged_by())%></td>
