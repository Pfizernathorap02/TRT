...
function sortables_init() {
    ...
    <!--<body>-->
        <p>
           <%
         ToviazLaunchReportList wc = (ToviazLaunchReportList)request.getAttribute(ListReportWpc.ATTRIBUTE_NAME);         
...
checkedManager = false;
	...
	<tr>
        ...
        <div>
	<div id="table_inst">
		<img src="<%=AppConst.APP_ROOT%>/resources/images/excel.gif" width="15px">&nbsp;<a href="<%=AppConst.APP_ROOT%>/ToviazLaunch/listreport?downloadExcel=true&excelType=<%=type%>&excelSection=<%=section%>">Download to Excel</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  href="<%=AppConst.APP_ROOT%>/ToviazLaunch/listreport?type=<%=type%>&section=<%=section%>">Back to default sort</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  href="<%=AppConst.APP_ROOT%>/ToviazLaunch/beginToviazLaunch?firstTime=true">Toviaz Launch Reports</a>        
	</div>
  ...
  <tr>
        ...
        String trmColor="";
         ...
         <td><%=b%><%=Util.toEmptyNBSP(emp.getFutureRBU())%><%=bb%></td>
				<td><%=b%><a href="<%=AppConst.APP_ROOT%>/RBU/employeeDetail/getEmployeeDetailsToviazLaunch?emplid=<%=emp.getEmplId()%>&m0=report&m1=ToviazLaunch&type=<%=type%>&section=<%=section%>"><%=emp.getLastName()%> </a><%=bb%></td>
				<td><%=b%><a href="<%=AppConst.APP_ROOT%>/RBU/employeeDetail/getEmployeeDetailsToviazLaunch?emplid=<%=emp.getEmplId()%>&m0=report&m1=ToviazLaunch&type=<%=type%>&section=<%=section%>"><%=emp.getFirstName()%></a><%=bb%></td>
