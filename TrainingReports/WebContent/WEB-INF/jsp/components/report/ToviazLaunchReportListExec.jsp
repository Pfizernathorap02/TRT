...
<%@ page import="com.pfizer.webapp.wc.components.report.ToviazLaunchReportListExec"%>
...
<%--<netui:html>--%>
    <head>
        <title>
            Toviaz Launch Training Schedule
        </title>
    </head>
...
function sortables_init() {
    ...
    <!--<body>-->
        <p>
           <%
         ToviazLaunchReportListExec wc = (ToviazLaunchReportListExec)request.getAttribute(ListReportWpc.ATTRIBUTE_NAME);         
...
function submitEmail() {
	...
	var ccString = '';
	var subjectStr = '&subject=Toviaz Launch Meeting Follow-up';	
...
checkedManager = false;
	...
	<tr>
        ...
        <div>
	<div id="table_inst">
		<img src="<%=AppConst.APP_ROOT%>/resources/images/excel.gif" width="15px">&nbsp;<a href="<%=AppConst.APP_ROOT%>/ToviazLaunch/listreportExec?downloadExcel=true&excelType=<%=type%>&excelSection=<%=section%>">Download to Excel</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  href="<%=AppConst.APP_ROOT%>/ToviazLaunch/listreportExec.do?type=<%=type%>&section=<%=section%>">Back to default sort</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  href="<%=AppConst.APP_ROOT%>/ToviazLaunch/beginToviazLaunchExec?firstTime=true">Toviaz Launch Executive Reports</a>        
	</div>
  ...
  <tr>
        ...
        String trmColor="";
         ...
         <td><%=b%><%=Util.toEmptyNBSP(emp.getFutureRBU())%><%=bb%></td>
				<td><%=b%><a href="<%=AppConst.APP_ROOT%>/RBU/employeeDetail/getEmployeeDetailsToviazLaunchExec?emplid=<%=emp.getEmplId()%>&m0=report&m1=ToviazLaunch&type=<%=type%>&section=<%=section%>"><%=emp.getLastName()%> </a><%=bb%></td>
				<td><%=b%><a href="<%=AppConst.APP_ROOT%>/RBU/employeeDetail/getEmployeeDetailsToviazLaunchExec?emplid=<%=emp.getEmplId()%>&m0=report&m1=ToviazLaunch&type=<%=type%>&section=<%=section%>"><%=emp.getFirstName()%></a><%=bb%></td>
