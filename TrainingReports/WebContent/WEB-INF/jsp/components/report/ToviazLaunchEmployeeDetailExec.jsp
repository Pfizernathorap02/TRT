...
<%@ page import="com.pfizer.webapp.wc.RBU.ToviazLaunchEmployeeDetailsExecWc"%>
...
<%
    ...
    ToviazLaunchEmployeeDetailsExecWc wc = (ToviazLaunchEmployeeDetailsExecWc)request.getAttribute(RBUEmployeeDetailsWc.ATTRIBUTE_NAME);
