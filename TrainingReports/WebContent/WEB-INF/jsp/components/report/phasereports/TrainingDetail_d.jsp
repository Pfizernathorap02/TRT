            ...
            if ( tmpstatus.isComplete() || tmpstatus.isRegistered() ) {
                ...
                if ( tmpstatus.getLevel() == 1 ) { 
                    ...
                    if ( tmpstatus.isSce() ) {         
                        ...
                        if(!SceHandler.isLMSMapped(emplid, productCd,"4",scoreLegend)){
                            ...
                            sb.append("<a href='/TrainingReports/phase/validateTRTActions.do?"+linkParamsStr+"&linkname=viewEval' onClick='OpenSpecialCase();' target='myWin' >View&nbsp;Evaluation(s)</a></td>");
                        }else{
                        ...
                        if ( tmpstatus.isRegistered() || tmpstatus.isAssigned() || tmpstatus.isComplete()||tmpstatus.isCancel() ) {
                           /* code added by pankaj for evaluation link issue*/ 
                            if ("Draft".equals(getSceStatus(emplid,tmpstatus,envt)) && tmpstatus.isRegistered()) {
                                sb.append("<td  style='font-size:14px;'><a href='/TrainingReports/phase/handleSpecialCase.do?productCode=" + tmpstatus.getCourseCode() + "&type=" + envt + "&activitypk=" + actid + "&emplid=" + emplid + "&sactivitid=" +tmpstatus.getActivityId() + "' onClick='OpenSpecialCase();' target='myWin' >Edit</a></td>");
                                ...
                                sb.append("<td  style='font-size:14px;'><a href='/TrainingReports/phase/handleSpecialCase.do?productCode=" + tmpstatus.getCourseCode() + "&type=" + envt + "&activitypk=" + actid + "&emplid=" + emplid + "&sactivitid=" +tmpstatus.getActivityId() + "' onClick='OpenSpecialCase();' target='myWin' >Evaluate</a></td>");
                            }
                             /* code added by pankaj for evaluation link issue*/ 
                ...
                if ( tmpstatus.getLevel() > 2 && tmpstatus.hasRecord(false)) {
                    ...
                    if ( isDebug ) {
                        ...
                        sb.append("<tr><td colspan='1' style='font-size:14px;' nowrap><a href='listReportAllStatus.do?activitypk="+tmpstatus.getActivityId()+"&section=Complete&pieIndex=0'>" + tmpStr + "</a></td>");
                    } else {
                        sb.append("<tr><td colspan='1' style='font-size:14px;' nowrap><a href='listReportAllStatus.do?activitypk="+tmpstatus.getActivityId()+"&section=Complete&pieIndex=0'>" + tmpstatus.getBuffer()+ tmpstatus.getActivityName() + "</a></td>");
                    }
                    //sb.append("<td  style='font-size:14px;'>"  + tmpstatus.getReportType() +  "</td>");
                    ...
                    if ( tmpstatus.isSce() ) {                        
                        ...
                        if("".equals(getSceScore(emplid,tmpstatus,"4"))){
                            ...
                            sb.append("<td  style='font-size:14px;'><a href='/TrainingReports/phase/validateTRTActions.do?"+linkParamsStr+"&linkName=reEvaluate' onClick='OpenSpecialCase();' target='myWin' >Re-Evaluate</a>");
                            sb.append("<br><a href='/TrainingReports/phase/validateTRTActions.do?"+linkParamsStr+"&linkName=viewEvaluations' onClick='OpenSpecialCase();' target='myWin' >View&nbsp;Evaluation(s)</a></td>");
                        }else{
                            sb.append("<td  style='font-size:14px;'><a href='/TrainingReports/phase/validateTRTActions.do?"+linkParamsStr+"&linkname=viewEvaluations' onClick='OpenSpecialCase();' target='myWin' >View&nbsp;Evaluation(s)</a></td>");
                        }
...
<tr>
       ...
       <img src="<%=AppConst.APP_ROOT%>/resources/images/excel.gif" width="15px">&nbsp;<a href="/TrainingReports/p2l/employeeSearchDetailPage.do?downloadTrainingDetail=true&activitypk=<%=wc.getActivityPk()//tmpstatus.getActivityId()%>&emplid=<%=wc.getEmployee().getEmplId()%>">Download to Excel</a>
       --%> 
        <img src="<%=AppConst.APP_ROOT%>/resources/images/excel.gif" width="15px">&nbsp;<a href="/TrainingReports/p2l/employeeSearchDetailPage?downloadTrainingDetail=true&activitypk=<%=wc.getActivityPk()%>&emplid=<%=wc.getEmployee().getEmplId()%>">Download to Excel</a>
        	...
        	<div class="phasedtraining_wrapper">
                <div class="phasedtraining_hdr_wrapper">
                    ...
                    %>
                        ...
                        <% if ((wc.getActivityPk() != null)  ) {%>
                        <%--Infosys migrated code weblogic to jboss changes start here
                        <a href="/TrainingReports/p2l/employeeSearchDetailPage.do?activitypk=<%=wc.getActivityPk()%>&emplid=<%=wc.getEmployee().getEmplId()%>" id="phasedtraining_tabLinks_on"  ><%=activity_str%></a>
                       --%> 
                       ...
                       <%-- 
                       <a href="/TrainingReports/p2l/employeeSearchDetailPage.do?activitypk=<%=wc.getActivityPk()%>&emplid=<%=wc.getEmployee().getEmplId()%>" ><%=activity_str%></a>
                     --%>
