...
<td>
        ...
        <div style="margin-left:10px;margin-right:10px">
            <div id="table_inst">
                ...
                <%-- <img src="<%=AppConst.APP_ROOT%>/resources/images/excel.gif" width="15px">&nbsp;<a href="<%=AppConst.APP_ROOT%>/CUE/listreport?downloadExcel=true&activitypk=<%=wc.getActivityPk()%>&section=<%=wc.getSection()%>">Download to Excel</a> --%>
                <img src="<%=AppConst.APP_ROOT%>/resources/images/excel.gif" width="15px">&nbsp;<a href="<%=AppConst.APP_ROOT%>/CUE/listreport?downloadExcel=true&activitypk=<%=wc.getActivityPk()%>&section=<%=wc.getSection()%>">Download to Excel</a>
