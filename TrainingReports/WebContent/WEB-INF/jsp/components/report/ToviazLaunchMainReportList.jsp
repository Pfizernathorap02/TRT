...
var url = '';
if(from==''){
     url = '/TrainingReports/ToviazLaunch/listreport?selectedBU='+encodeURIComponent(bu)+'&selectedRBU='+encodeURIComponent(rbu)+'&fromRequest=reRun';
}
else{
    url = '/TrainingReports/ToviazLaunch/listreportExec?selectedBU='+encodeURIComponent(bu)+'&selectedRBU='+encodeURIComponent(rbu)+'&fromRequest=reRun';
}
