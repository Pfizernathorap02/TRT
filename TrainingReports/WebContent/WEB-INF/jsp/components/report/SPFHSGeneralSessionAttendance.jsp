...
<html>
    <head>
        <title>
            SPF - General Session Attendance Report
        </title>
    </head>
...
<%--       Infosys code changes starts here
  <form action="<%=AppConst.APP_ROOT%>/SPF/SPFHSReportGeneralSessionAttendance.do" method="post" class="form_basic"> --%>
                <form action="<%=AppConst.APP_ROOT%>/SPF/SPFHSReportGeneralSessionAttendance" method="post" class="form_basic">
<%--       Infosys code changes ends here --%>
        ...
        <div style="margin-left:10px;margin-right:10px">
            <div id="table_inst">
              <%--  Infosys code changes starts here
               <img src="<%=AppConst.APP_ROOT%>/resources/images/excel.gif" width="15px">&nbsp;<a href="<%=AppConst.APP_ROOT%>/SPF/SPFHSReportGeneralSessionAttendance.do?downloadExcel=true&<%=wc.getClassFilterForm().FIELD_CLASSROOM%>=<%=form.getClassRoom()%>&<%=wc.getClassFilterForm().FIELD_TRAININGDATE%>=<%=form.getTrainingDate()%>">Download to Excel</a>
                &nbsp;&nbsp;|&nbsp;&nbsp;
                <a href="<%=AppConst.APP_ROOT%>/spfreportselect.do">SPF Reports Home</a> --%>
                  <img src="<%=AppConst.APP_ROOT%>/resources/images/excel.gif" width="15px">&nbsp;<a href="<%=AppConst.APP_ROOT%>/SPF/SPFHSReportGeneralSessionAttendance?downloadExcel=true&<%=wc.getClassFilterForm().FIELD_CLASSROOM%>=<%=form.getClassRoom()%>&<%=wc.getClassFilterForm().FIELD_TRAININGDATE%>=<%=form.getTrainingDate()%>">Download to Excel</a>
                &nbsp;&nbsp;|&nbsp;&nbsp;
        ...
        <%if (downloadExcel) {%>
        <tr>
            <td colspan="5"><b>SPF - General Session Attendance Report</b></td>
        </tr>
        <tr></tr>
        <tr>
            <td><label>Class Room:</label></td>
