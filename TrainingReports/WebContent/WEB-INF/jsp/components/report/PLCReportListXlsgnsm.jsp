         ...
         <tr  >
				...
				<td>&nbsp;<%=emp.getEmplId()%></td>
                 ...
                 <%if("Overall".equalsIgnoreCase(xlsType)){
                    ...
                    %>
                    <td ><%=Util.toEmptyNA((String)empHashMap.get("GEODE1"))%></td>
                    <td ><%=Util.toEmptyNA((String)empHashMap.get("GEODE2"))%></td>
                    <td ><%=Util.toEmptyNA((String)empHashMap.get("GEODSY"))%></td>
                    <td ><%=Util.toEmptyNA((String)empHashMap.get("GEODVL"))%></td>
                    <td ><%=Util.toEmptyNA((String)empHashMap.get("GEODAT"))%></td>
                    <td ><%=section%></td>
