...
<html>
    ...
    <body>
        ...
        <h3 style="MARGIN-TOP:15PX">
            SPF - Class Roster Report
        </h3>
        <table class="basic_table" style="margin-left:10px;margin-right:10px">
        <%-- Infosys code changes starts here
        <form action="<%=AppConst.APP_ROOT%>/SPF/SPFHSReportClassRoster.do" method="post" class="form_basic">
         --%>
    <form action="<%=AppConst.APP_ROOT%>/SPF/SPFHSReportClassRoster" method="post" class="form_basic">
        ...
        <%if (downloadExcel) {%>
        <tr>
            <td colspan="5"><b>SPF - Class Roster Report</b></td>
        </tr>
        <tr></tr>
        <tr>
            <td><label>Class Room:</label></td>
