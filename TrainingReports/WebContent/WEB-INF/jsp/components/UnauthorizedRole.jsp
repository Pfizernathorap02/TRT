...
<html>
    <head>
        ...
        <link href="<%=request.getContextPath()%>/resources/css/trainining.css" rel="stylesheet" type="text/css" media="all" />
        <!--[if IE 6]>
    ...
    <body id="p-contact">
        <div id="wrap">
            ...
            <div id="main_content">
                <h4>Your account is not authorized for control panel options.</h4>
                <div class="clear"></div>	
            </div> <!-- end #content -->
