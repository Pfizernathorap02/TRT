...
<%@ page import="com.pfizer.webapp.wc.components.search.AllEmployeeSearchWc"%>
<%@ page import="com.pfizer.webapp.wc.components.search.SimulateSearchWc"%>
...
<%
	AllEmployeeSearchWc wc = (AllEmployeeSearchWc)request.getAttribute(AllEmployeeSearchWc.ATTRIBUTE_NAME);
%>
