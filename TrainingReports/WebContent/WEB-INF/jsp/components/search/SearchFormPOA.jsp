...
<%@ page import="com.pfizer.webapp.wc.components.search.SearchFormPOAWc"%>
...
<%
	SearchFormPOAWc wc = (SearchFormPOAWc)request.getAttribute(SearchFormPOAWc.ATTRIBUTE_NAME);
%>

<table class="no_space_width">
	<form name="searchForm" action="<%=AppConst.APP_ROOT%>/searchPOA" class="form_basic" method="get">
		<tr>
