...
<%@ page import="com.pfizer.webapp.wc.components.search.SearchResultListVRSWc"%>
...
<%
	SearchResultListVRSWc wc = (SearchResultListVRSWc)request.getAttribute(SearchResultListVRSWc.ATTRIBUTE_NAME);
...
<%	    
    ...
    <%}%>                            
            <td>
                ...
                <a href="<%=AppConst.APP_ROOT%>/PWRA/employeeDetail/getEmployeeDetail.do?emplid=<%=emp.getEmplId()%>&m1=VRS&m0=search">                            
                --%>
               <a href="<%=AppConst.APP_ROOT%>/PWRA/employeeDetail/getEmployeeDetail?emplid=<%=emp.getEmplId()%>&m1=VRS&m0=search">                            
