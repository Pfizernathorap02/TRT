...
<%@ page import="com.pfizer.webapp.wc.components.search.searchResultWc"%>
...
<%
System.out.println("IN NA USER SEARCH");
	searchResultWc wc = (searchResultWc)request.getAttribute(searchResultWc.ATTRIBUTE_NAME);
%>
