...
<%@ page import="com.pfizer.webapp.wc.components.search.EmployeeSearchWc"%>
...
<%
	EmployeeSearchWc wc = (EmployeeSearchWc)request.getAttribute(EmployeeSearchWc.ATTRIBUTE_NAME);
%>
