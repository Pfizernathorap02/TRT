...
<%@ page import="com.pfizer.webapp.wc.components.search.SearchResultListMSEPIWc"%>
...
<%
	SearchResultListMSEPIWc wc = (SearchResultListMSEPIWc)request.getAttribute(SearchResultListMSEPIWc.ATTRIBUTE_NAME);
    ...
    <%}%>                            
            <td>
             <%-- Infosys code changes starts here
                <a href="<%=AppConst.APP_ROOT%>/PWRA/employeeDetail/getEmployeeDetail.do?emplid=<%=emp.getEmplId()%>&m1=MSEPI&m0=search">                            
                --%>
                <a href="<%=AppConst.APP_ROOT%>/PWRA/employeeDetail/getEmployeeDetail?emplid=<%=emp.getEmplId()%>&m1=MSEPI&m0=search">                            
