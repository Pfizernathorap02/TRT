...
<%@ page import="com.pfizer.webapp.wc.components.search.EmployeeSearchTSHTWc"%>
...
<%
	EmployeeSearchTSHTWc wc = (EmployeeSearchTSHTWc)request.getAttribute(EmployeeSearchTSHTWc.ATTRIBUTE_NAME);    
%>
...
<table class="basic_table">
	...
	<tr>
		<td align="center"><inc:include-wc component="<%=wc.getSearchFormTSHTWc()%>"/></td>
	</tr>
	<tr>
