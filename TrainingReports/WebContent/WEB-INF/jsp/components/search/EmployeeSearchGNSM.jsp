...
<%
	EmployeeSearchGNSMWc wc = (EmployeeSearchGNSMWc)request.getAttribute(EmployeeSearchGNSMWc.ATTRIBUTE_NAME);    
%>
...
<table class="basic_table">
	...
	<tr>
		<td align="center"><inc:include-wc component="<%=wc.getSearchFormGNSMWc()%>"/></td>
	</tr>
	<tr>
