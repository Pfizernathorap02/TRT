...
<%
	EmployeeSearchPDFHSWc wc = (EmployeeSearchPDFHSWc)request.getAttribute(EmployeeSearchPDFHSWc.ATTRIBUTE_NAME);    
%>
...
<table class="basic_table">
	...
	<tr>
		<td align="center"><inc:include-wc component="<%=wc.getSearchFormPDFHSWc()%>"/></td>
	</tr>
	<tr>
