...
<%@ page import="com.pfizer.webapp.wc.components.searchCourseTrainingPathWc"%>
...
<%            
	searchCourseTrainingPathWc wc = (searchCourseTrainingPathWc)request.getAttribute(searchCourseTrainingPathWc.ATTRIBUTE_NAME);
...
<form class="form_basic" method="post" action="/TrainingReports/adminHome/searchCourseTrainingPath?track=<%=wc.getTrackId()%>">
<table />
<tr>
    <td colspan="2">
        Name
