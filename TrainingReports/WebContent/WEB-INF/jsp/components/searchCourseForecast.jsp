...
<%@ page import="com.pfizer.webapp.wc.components.SearchCourseForecastWc"%>
...
<%            
	SearchCourseForecastWc wc = (SearchCourseForecastWc)request.getAttribute(SearchCourseForecastWc.ATTRIBUTE_NAME);
...
function selectedActivityForecast(){
        var idSelected= new Array();
        var valueSelected= new Array();
        var j = 0;
        
            for(var i=1;i<document.form1.length;++i) { 
...
<form class="form_basic" method="post" action="/TrainingReports/adminHome/searchCourseForecast?">
<table />
<tr>
    <td colspan="2">
        Name
...
<tr>
<td>
    <input class="text" type="text" name="<%=SearchCourseForecastWc.FIELD_ACTIVITY_NAME%>" value="<%=wc.getActivityname()%>">
</td>
<td>
Or
</td>
<td> 
    <input class="text" type="text" name="<%=SearchCourseForecastWc.FIELD_CODE%>" value="<%=wc.getCode()%>">
</td>
...
<form name="form1" action="" method="post" onsubmit="this.submit();window.close();" target="main" >
<%if(wc.getSearchResults()!=null&&wc.getSearchResults().size()>0){%>
<table class="blue_table_without_border">
       <tr><td><b>&nbsp;&nbsp;Instructions :</b></td></tr>
       <tr><td>&nbsp;&nbsp;1.&nbsp;Check the checkboxes to select courses.</td></tr>
       <tr><td>&nbsp;&nbsp;2.&nbsp;Click on "Insert Selected" button at last ,to append the selections</td></tr>
       <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to the "Available Courses" in the Main window.</td></tr>
       </table>
       <br>
<table class="blue_table" width="90%">
<tr><th width="100"><input type ="checkbox" id ="SelectAll1" name="SelectAll" onclick="javascript:selectAll('SelectAll1');" >Select All</th>
<th width="150"><input type ="button" id ="Select" name="Select" value="Insert Selected" onclick="javascript:selectedActivityForecast();"></th>
<th >&nbsp;</th>
</tr>
</table>
<%}%>
...
<%  }   %>
    ...
    <%if(wc.getSearchResults()!=null&&wc.getSearchResults().size()>0){%>
     <table class="blue_table" width="90%">
<tr><th width="100"><input type ="checkbox" id ="SelectAll2" name="SelectAll" onclick="javascript:selectAll('SelectAll2');" >Select All</th>
<th width="150"><input type ="button" id ="Select" name="Select" value="Insert Selected" onclick="javascript:selectedActivityForecast();"></th>
<th>&nbsp;</th>
</tr>
</table>
