...
<%@ page import="com.pfizer.webapp.wc.components.AdmintoolsSelectRBUWc"%>
<%@ page import="com.pfizer.webapp.wc.components.ProductSelectWc"%>
<%@ page import="com.pfizer.webapp.wc.components.ReportSelectWc"%>
<%@ page import="com.pfizer.webapp.wc.components.admintoolsSelectSPFHSWc"%>
...
<%
	AdmintoolsSelectRBUWc wc = (AdmintoolsSelectRBUWc)request.getAttribute(AdmintoolsSelectRBUWc.ATTRIBUTE_NAME);
		...
		<td>
            <table class="no_space_width">
                <tr>
                    ...
                    <td><br>
                        <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:openSessionAttendanceSPF();"> > General Session Attendance</a></h5>                        
                    </td>
                </tr>
			</table>
		</td>
