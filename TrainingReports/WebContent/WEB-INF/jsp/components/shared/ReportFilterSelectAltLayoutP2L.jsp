...
<script type="text/javascript" language="JavaScript">	
	function getNextLevel(id,level) {
       ...
       // alert(tmpSel);
        ...
        window.location="/TrainingReports/p2l/getNextP2lPhaseLevel?<%=AppQueryStrings.FIELD_SALES%>=" +selected_text+"&<%=AppQueryStrings.FIELD_SALESVALUE%>="+selected_value+"&<%=AppQueryStrings.FIELD_SALESORG%>="+selected_sales_text+"&<%=AppQueryStrings.FIELD_SALESLEVEL%>="+level;     
    }
...
<table class="basic_table" border="2" width="0" style="font-size=12">
<form name ="selOptionalFieldsForm" id ="selOptionalFieldsForm" action="<%=wc.getPostUrl()%>" method="post" class="form_basic">
        <%--/* Added for Phase 1 by Meenakshi */ --%>       	
<tr >
