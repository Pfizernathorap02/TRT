...
<%@ page import="com.pfizer.webapp.wc.PDFHS.PDFHSChartsWc"%>
<%@ page import="com.pfizer.webapp.wc.SPF.SPFChartsWc"%>
...
<%
	SPFChartsWc wc = (SPFChartsWc)request.getAttribute(SPFChartsWc.ATTRIBUTE_NAME);
