...
<html>
    <head>
        <title>
            Product Training (PSCPT)  Sandbox Refresh Confirmation           
        </title>
        <style type="text/css">
    ...
    <body onload="window.focus();">    
        ...
        <TABLE class="TblBrdr" cellpadding="2" cellspacing="0" width="100%"  height="100%" align="center">
        <TR>
        <TD>
            Product Training (PSCPT) Sandbox Refresh process has been successfully completed.  
        </TD>
        </TR>  
        <TR>
        <TD>
