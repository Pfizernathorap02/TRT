...
<html>
    <head>
        <title>
           P4 Training - Search Employee for Personalized Agenda
        </title>
...
//         if(orderNum.length==0)
  //       {
    //       alert('Enter Employee No. to be searched.');
      //     return;
        //  }
          ...
          url="<%=PageflowTagUtils.getRewrittenFormAction("employeesForSearchAgendaP4", pageContext)%>?orderNumber="+encodeURIComponent(orderNum)+"&SearchType=loaEmployee&lastName="+encodeURIComponent(lastName)+"&firstName="+encodeURIComponent(firstName)+"&week="+encodeURIComponent(week);     
          --%>
          url="/TrainingReports/PrintHome/employeesForSearchAgendaP4?orderNumber="+encodeURIComponent(orderNum)+"&SearchType=loaEmployee&lastName="+encodeURIComponent(lastName)+"&firstName="+encodeURIComponent(firstName)+"&week="+encodeURIComponent(week);    
      ...
      <%--  Infosys code changes starts here
      var url="<%=PageflowTagUtils.getRewrittenFormAction("printSearchEmployeeAgendaP4", pageContext)%>?orderNumber="+encodeURIComponent(orderNum)+"&SearchType=loaEmployee&lastName="+encodeURIComponent(lastName)+"&firstName="+encodeURIComponent(firstName)+"&week="+encodeURIComponent(week);
       --%>
         var url="/TrainingReports/PrintHome/printSearchEmployeeAgendaP4?orderNumber="+encodeURIComponent(orderNum)+"&SearchType=loaEmployee&lastName="+encodeURIComponent(lastName)+"&firstName="+encodeURIComponent(firstName)+"&week="+encodeURIComponent(week);

       <%-- Infosys code changes ends here --%>
       
      var appURL = "<%=request.getRequestURL()%>";
       var requestURL = '';
       if (appURL.indexOf("localhost:8619") != -1 || appURL.indexOf("trt-dev.pfizer.com") != -1 || appURL.indexOf("trt-dev") != -1){
    ...
    <body>
    <jsp:include page="HeaderNoHomeLinkForAgendaP4.jsp" />
     ...
     /*    Infosys code changes ends here */
       ...
       <%
        /*  TreeMap employeeReportMap=(TreeMap)pageContext.getAttribute("employeeResultMap"); */
         TreeMap employeeReportMap=(TreeMap)request.getAttribute("searchmployeeForAgendaMap");
