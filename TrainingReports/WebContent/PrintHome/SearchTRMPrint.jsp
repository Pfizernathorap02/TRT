...
<object viewastext id="factory" style="display:none"
 classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814">
    ...
    String printMsgToDisp=session.getAttribute("printMsgToDisp")==null?"":session.getAttribute("printMsgToDisp").toString();
    %>
    ...
    <div style="MARGIN:15PX" id="main_body" >
        ...
        <div id="print_status" style="">
         <br>
            <br>
            <b>Preparing for Printing Shipment Letters.....<b>&nbsp;&nbsp;&nbsp;&nbsp;
            <b>&nbsp;&nbsp;&nbsp;<b>&nbsp;&nbsp;&nbsp;&nbsp;
            <br>
            <br>
        ...
        String path="";
        //path="http://trint.pfizer.com/TrainingReports/PrintHome/Templates/CreatedLabels";
        //LoggerHelper.logSystemDebug("This is hardcoded dude ->>>>>>" +path);
        //String pathNew="";
        //pathNew="http://trint.pfizer.com/TrainingReports/PrintHome/Templates/CreatedLabels";
       // LoggerHelper.logSystemDebug("This is hardcoded NEW PATH buddy ->>>>>>" +pathNew);
        String orderNumber="";
        int  count=0;
        String content="";
        File labelFile;
        ...
        for(Iterator iter=invitationMap.keySet().iterator();iter.hasNext();){
          ...
          /* if(PrintingConstants.env_type.equalsIgnoreCase(PrintingConstants.env_staging)){
               ...
               //path="http://trstg.pfizer.com/TrainingReports/PrintHome/Templates/CreatedLabels//INV"+orderNumber.trim()+".html";
                ...
                //path = "http://trint.pfizer.com/TrainingReports/PrintHome/Templates/CreatedLabels//INV"+orderNumber.trim()+".html";
                //pathNew = pathNew + "//INV"+orderNumber.trim()+".html";
               // LoggerHelper.logSystemDebug("The New Path is: Does this look any good?:" +pathNew);
                //labelFile=new File(pathNew);
          ...
          // LoggerHelper.logSystemDebug("The Path here is: Not so funny:" +pathNew);
           LoggerHelper.logSystemDebug("The Path here is: Not so funny:" +path  + "Server Name" + serverName);
          ...
          %>
            ...
            <script>
             ...
             printWithNoPrompt('<%=path%>','<%=sOrderNo%>');
             </script>
           <%
           }//end of the for loop
           }
